...
const DashboardLayout = ({ children }: React.PropsWithChildren<DashboardLayoutProps>) => {
    ...
    <div className="bg-slate-100 h-screen">
      <div className="w-full grid grid-rows-[auto_1fr]">
        <div className="bg-slate-200 border-b border-slate-300">
          <header className="flex justify-between py-2 w-full max-w-5xl mx-auto items-center">
              ...
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Portal>
                  <DropdownMenu.Content
                    sideOffset={1}
                    align="end"
                    className="min-w-56 bg-slate-100 shadow rounded border border-slate-300"
                  >
